...
public class ObjectWebKeys {
	...
	public static final String OBJECT_DEFINITIONS_DETAILS_DISPLAY_CONTEXT =
		"OBJECT_DEFINITIONS_DETAILS_DISPLAY_CONTEXT";

	public static final String OBJECT_DEFINITIONS_FIELDS_DISPLAY_CONTEXT =
		"OBJECT_DEFINITIONS_FIELDS_DISPLAY_CONTEXT";

	public static final String OBJECT_DEFINITIONS_RELATIONSHIP_DISPLAY_CONTEXT =
		"OBJECT_DEFINITIONS_RELATIONSHIP_DISPLAY_CONTEXT";
