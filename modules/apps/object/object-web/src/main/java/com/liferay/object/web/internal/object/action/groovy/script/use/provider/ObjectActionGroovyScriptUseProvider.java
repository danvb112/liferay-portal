...
package com.liferay.object.web.internal.object.action.groovy.script.use.provider;
...
public class ObjectActionGroovyScriptUseProvider
		...
		return TransformUtil.transform(
			...
			objectAction -> {
				...
				return new GroovyScriptUse(
					company.getWebId(),
					objectAction.getLabel(resourceRequest.getLocale()), url);
			});
	}
